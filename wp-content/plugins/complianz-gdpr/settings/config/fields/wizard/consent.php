		...
		array(
			array(
				...
				'help'     => array(
					...
					'text'  => __(
						'If you want to clear all cookies from the plugin, you can do so here. If you want to start with a clean slate, you might need to clear your browsercache, to make sure all cookies are removed from your browser as well.',
						'complianz-gdpr'
					),
			...
			array(
				...
				'options'                 => array(
					'gtg'                => __( 'Yes, I use Google Tag Gateway', 'complianz-gdpr' ),
			...
			array(
				...
				'tooltip'                 => __(
					'When checking all three checkboxes, we will set statistics to anonymous. Based on your region, statistics might be set before consent.',
					'complianz-gdpr'
				),
				...
				'help'                    => array(
					...
					'text'  => __(
						'If you select the option that IP addresses are anonymized, and let Complianz handle the statistics, Complianz will ensure that ip addresses are anonymized by default, unless consent is given for statistics.',
						'complianz-gdpr'
					),
			...
			array(
				'id'               => 'gtg_deployment_steps_notice',
				'menu_id'          => 'consent-statistics',
				'group_id'         => 'consent-statistics',
				'type'             => 'hidden',
				'react_conditions' => array(
					'relation' => 'AND',
					array(
						'compile_statistics' => 'gtg',
					),
				),
				'help'             => array(
					'label' => 'default',
					'title' => __( 'GTG Deployment Steps', 'complianz-gdpr' ),
					'text'  => __( 'Do you want to know about GTG deployment steps?', 'complianz-gdpr' ),
					'url'   => 'https://complianz.io/google-tag-gateway',
				),
			),
			array(
				'id'                      => 'compile_statistics_more_info_gtg',
				'menu_id'                 => 'statistics-configuration',
				'order'                   => 5,
				'type'                    => 'radio',
				'revoke_consent_onchange' => true,
				'default'                 => '',
				'label'                   => __( 'Which of the following applies to your website?', 'complianz-gdpr' ),
				'options'                 => array(
					'google-tag-manager' => __( 'I use Google Tag Manager', 'complianz-gdpr' ),
					'google-analytics'   => __( 'I use Google Analytics', 'complianz-gdpr' ),
				),
				'react_conditions'        => array(
					'relation' => 'AND',
					array(
			...
			array(
				...
				'react_conditions' => array(
					'relation' => 'AND',
					array(
						'compile_statistics' => array( 'google-analytics', 'matomo', 'yandex', 'clicky', 'google-tag-manager', 'matomo-tag-manager' ),
					),
				),
			...
			array(
				...
				'comment'          => cmplz_sprintf( __( 'Please read this %1$sarticle%2$s to make sure Consent Mode is working as expected.', 'complianz-gdpr' ), '<a target="_blank" href="https://complianz.io/simplified-guide-to-google-consent-mode-v2/">', '</a>' ),
				'options'          => array(
					'yes' => __( 'Yes', 'complianz-gdpr' ),
					'no'  => __( 'No', 'complianz-gdpr' ),
				),
				...
				'react_conditions' => array(
					'relation' => 'AND',
					array(
						'compile_statistics'         => array( 'google-analytics', 'google-tag-manager' ),
			...
			array(
				...
				'react_conditions'        => array(
					...
					array(
						...
						array(
							'compile_statistics' => 'gtg',
							'compile_statistics_more_info_gtg' => 'google-analytics',
						),
					),
				),
